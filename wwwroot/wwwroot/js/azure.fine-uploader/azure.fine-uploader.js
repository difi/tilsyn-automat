            ...
            _deleteBlob: function (relatedToCancel, id) {
                var self = this, deleteBlobSasUri = {}, blobUriStore = {
                    ...
                    onDeleteComplete: function (id, xhrOrXdr, isError) {
                        ...
                        $("#" + hidden.attr("id").replace("answer_image_", "")).find(".qq-upload-button").show();
        ...
        qq.extend(this, {
            ...
            uploadFile: function (id) {
                ...
                getSignedUrl(id).then(function (sasUri) {
                    ...
                    //FUNKA Custom code start
                    $("[qq-button-id='" + fileOrBlob.qqButtonId + "']").closest(".qq-upload-button").hide();
                    $("[qq-button-id='" + fileOrBlob.qqButtonId + "']").closest(".qq-uploader").find(".qq-upload-status").show();
                    //FUNKA Custom code end

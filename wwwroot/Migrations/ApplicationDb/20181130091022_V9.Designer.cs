            ...
            modelBuilder.Entity("Difi.Sjalvdeklaration.Shared.Classes.Declaration.Rules.AnswerItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = new Guid("a1964762-5c8f-40bb-a22d-c907149079d4"), AlwaysVisible = false, Bool = false, LinkedParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), LinkedParentFailedId = new Guid("00000000-0000-0000-0000-000000000000"), MaxInt = 0, MinInt = 0, Order = 1, Question = "Henger det gjenstander over kundens betjeningsområde?", RuleItemId = new Guid("b64cac7e-6525-49e8-9112-0238e1588ed8"), TypeOfAnswerId = 2 },
                        new { Id = new Guid("8a12d92b-8a6a-44e7-9517-74331a4c2483"), AlwaysVisible = false, Bool = false, LinkedParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), LinkedParentFailedId = new Guid("00000000-0000-0000-0000-000000000000"), MaxInt = 0, MinInt = 0, Order = 3, Question = "Ta bilde", RuleItemId = new Guid("b64cac7e-6525-49e8-9112-0238e1588ed8"), TypeOfAnswerId = 4 },
                        new { Id = new Guid("bf459d05-702d-47d7-a5b7-19f8b3fb67c9"), AlwaysVisible = false, Bool = false, LinkedParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), LinkedParentFailedId = new Guid("a1964762-5c8f-40bb-a22d-c907149079d4"), MaxInt = -1, MinInt = 220, Order = 2, Question = "Hvor mange cm over gulvet henger den laveste gjenstanden i kundens betjeningsområde?", RuleItemId = new Guid("b64cac7e-6525-49e8-9112-0238e1588ed8"), TypeOfAnswerId = 3 },
                        ...
                        new { Id = new Guid("f69c1e45-99d8-4293-a242-c5ed9e126e99"), AlwaysVisible = false, Bool = true, LinkedParentCorrectId = new Guid("d8611e84-0f00-4d75-bcab-cbf127fb68b5"), LinkedParentFailedId = new Guid("00000000-0000-0000-0000-000000000000"), MaxInt = 0, MinInt = 0, Order = 3, Question = "Er skiltet synlig på avstand utenfor kundens betjeningsområde?", RuleItemId = new Guid("832e0843-cab3-4dbc-9799-974e283fcc0b"), TypeOfAnswerId = 2 },
                        new { Id = new Guid("f98f67e5-cf6a-4afe-8998-3132640f9d70"), AlwaysVisible = false, Bool = true, BoolFalseText = "Nej", BoolTrueText = "Mellom 75cm og 130cm over gulvet", LinkedParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), LinkedParentFailedId = new Guid("00000000-0000-0000-0000-000000000000"), MaxInt = 0, MinInt = 0, Order = 1, Question = "Hvor mange cm er det fra gulvet og opp til betalingsterminalen?", RuleItemId = new Guid("5b3af04b-f6c6-4425-a22f-c2e7479839a5"), TypeOfAnswerId = 2 },

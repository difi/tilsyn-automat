            ...
            modelBuilder.Entity("Difi.Sjalvdeklaration.Shared.Classes.Declaration.Rules.IndicatorOutcomeAnswerItem", b =>
                {
                    ...
                    b.ToTable("IndicatorOutcomeAnswerList");

                    b.HasData(
                        new { Id = new Guid("d48f8630-230a-4285-8b78-6bb9049054b1"), AnswerItemId = new Guid("02d2db89-3717-48e1-883e-8e526bf6c727"), IndicatorOutcomeItemId = new Guid("0025bb09-6dfe-4069-ae6b-27cb28ba8300"), ResultId = 1 },
                        new { Id = new Guid("708cc5c8-d433-4bf4-b179-8d8c81b6bd6e"), AnswerItemId = new Guid("a1964762-5c8f-40bb-a22d-c907149079d4"), IndicatorOutcomeItemId = new Guid("0025bb09-6dfe-4069-ae6b-27cb28ba8300"), ResultId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("Difi.Sjalvdeklaration.Shared.Classes.Declaration.Rules.IndicatorOutcomeItem", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("0025bb09-6dfe-4069-ae6b-27cb28ba8300"), IndicatorItemId = new Guid("692627b2-53bc-43f2-900d-44a40a21e7e9"), Order = 1 },
                        new { Id = new Guid("d438e931-f57c-4a5c-bb5c-3e3a66824827"), IndicatorItemId = new Guid("692627b2-53bc-43f2-900d-44a40a21e7e9"), Order = 2 },
                        new { Id = new Guid("d18a7bce-556c-45cc-87d7-c765261166d5"), IndicatorItemId = new Guid("692627b2-53bc-43f2-900d-44a40a21e7e9"), Order = 3 },
                        new { Id = new Guid("a9b2bb20-7240-4a93-ba1a-ae270e8679f1"), IndicatorItemId = new Guid("692627b2-53bc-43f2-900d-44a40a21e7e9"), Order = 4 },
                        new { Id = new Guid("4edceffe-eb77-4ca0-a498-24be5372d333"), IndicatorItemId = new Guid("692627b2-53bc-43f2-900d-44a40a21e7e9"), Order = 5 },
                        new { Id = new Guid("6cd1b621-12e6-4a03-bd6e-a7c8b39de251"), IndicatorItemId = new Guid("692627b2-53bc-43f2-900d-44a40a21e7e9"), Order = 6 }
                    );
                });

            ...
            modelBuilder.Entity("Difi.Sjalvdeklaration.Shared.Classes.Declaration.Rules.AnswerItem", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("02d2db89-3717-48e1-883e-8e526bf6c727"), Bool = false, MaxInt = 0, MinInt = 0, Order = 1, RuleItemId = new Guid("eb160c6c-3a9e-4dff-93df-577d9eab4e09"), TypeOfAnswerId = 2 },
                        new { Id = new Guid("6912d4a0-b73b-4ecc-9fa8-49e1fd356635"), Bool = false, MaxInt = 0, MinInt = 0, Order = 2, RuleItemId = new Guid("eb160c6c-3a9e-4dff-93df-577d9eab4e09"), TypeOfAnswerId = 4 },
                        new { Id = new Guid("d7b40e3c-e7fa-44e5-b44f-750759c971cc"), Bool = false, MaxInt = 0, MinInt = 0, Order = 1, RuleItemId = new Guid("b64cac7e-6525-49e8-9112-0238e1588ed8"), TypeOfAnswerId = 1 },
                        new { Id = new Guid("a1964762-5c8f-40bb-a22d-c907149079d4"), Bool = false, MaxInt = 0, MinInt = 0, Order = 1, RuleItemId = new Guid("a1a1b0f2-441a-4726-ab6c-85e8d08ffed0"), TypeOfAnswerId = 2 },
                        new { Id = new Guid("8a12d92b-8a6a-44e7-9517-74331a4c2483"), Bool = false, MaxInt = 0, MinInt = 0, Order = 2, RuleItemId = new Guid("a1a1b0f2-441a-4726-ab6c-85e8d08ffed0"), TypeOfAnswerId = 4 },
                        new { Id = new Guid("bf459d05-702d-47d7-a5b7-19f8b3fb67c9"), Bool = false, MaxInt = -1, MinInt = 220, Order = 1, RuleItemId = new Guid("b504bde7-1394-4e5c-84d3-a3ac53fc7dd6"), TypeOfAnswerId = 3 },
                        new { Id = new Guid("202d20e0-61df-4a7c-8287-104e3b439f64"), Bool = false, MaxInt = 0, MinInt = 0, Order = 1, RuleItemId = new Guid("0d6c763e-e0f6-4049-adeb-ae9429262b57"), TypeOfAnswerId = 2 },
                        new { Id = new Guid("13d6d530-e533-4510-9a66-8b862899dbdf"), Bool = false, MaxInt = 0, MinInt = 0, Order = 2, RuleItemId = new Guid("0d6c763e-e0f6-4049-adeb-ae9429262b57"), TypeOfAnswerId = 4 },
                        new { Id = new Guid("89fd2205-1047-403d-a5bd-f70a1de2f247"), Bool = false, MaxInt = -1, MinInt = 150, Order = 1, RuleItemId = new Guid("b9498453-f173-499a-b01d-91cb469cc5ec"), TypeOfAnswerId = 3 },
                        new { Id = new Guid("d8611e84-0f00-4d75-bcab-cbf127fb68b5"), Bool = true, MaxInt = 0, MinInt = 0, Order = 1, RuleItemId = new Guid("832e0843-cab3-4dbc-9799-974e283fcc0b"), TypeOfAnswerId = 2 },
                        new { Id = new Guid("c4870935-ee11-4557-a9c3-aca678c17565"), Bool = false, MaxInt = 0, MinInt = 0, Order = 2, RuleItemId = new Guid("832e0843-cab3-4dbc-9799-974e283fcc0b"), TypeOfAnswerId = 4 },
                        new { Id = new Guid("9a51cc68-857e-4822-ac81-0ec3ebe7bf43"), Bool = true, MaxInt = 0, MinInt = 0, Order = 1, RuleItemId = new Guid("4c4cd93b-ad4c-49b3-af05-f9e9fc7cb15a"), TypeOfAnswerId = 2 },
                        new { Id = new Guid("f69c1e45-99d8-4293-a242-c5ed9e126e99"), Bool = true, MaxInt = 0, MinInt = 0, Order = 1, RuleItemId = new Guid("5cec30b8-2c28-4f7e-b9d7-6655a745c2ef"), TypeOfAnswerId = 2 },
                        new { Id = new Guid("f98f67e5-cf6a-4afe-8998-3132640f9d70"), Bool = false, MaxInt = 130, MinInt = 75, Order = 1, RuleItemId = new Guid("5b3af04b-f6c6-4425-a22f-c2e7479839a5"), TypeOfAnswerId = 3 }
                    );
                });
            ...
            modelBuilder.Entity("Difi.Sjalvdeklaration.Shared.Classes.Declaration.Rules.RuleItem", b =>
                {
                    ...
                    b.Property<bool>("ViewIfParentFailed");
                    ...
                    b.HasData(
                        new { Id = new Guid("eb160c6c-3a9e-4dff-93df-577d9eab4e09"), ChapterItemId = new Guid("731a0f5c-f586-471f-b32c-ceb8027f735a"), HelpText = "", Instruction = "Finnes det hindringer i kundens betjeningsområde?", Order = 4, RequirementItemId = new Guid("875e76b5-c926-43a0-8738-c4f41c7a0b8b"), StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2"), ToolsNeed = "Ingen", ViewIfParentFailed = false },
                        new { Id = new Guid("b64cac7e-6525-49e8-9112-0238e1588ed8"), ChapterItemId = new Guid("731a0f5c-f586-471f-b32c-ceb8027f735a"), HelpText = "", Instruction = "Beskriv hindringene i kundens betjeningsområde.", Order = 5, RequirementItemId = new Guid("875e76b5-c926-43a0-8738-c4f41c7a0b8b"), StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2"), ToolsNeed = "Ingen", ViewIfParentFailed = true },
                        new { Id = new Guid("a1a1b0f2-441a-4726-ab6c-85e8d08ffed0"), ChapterItemId = new Guid("b80b9b15-8f0e-4702-b7d9-95cafa68f9fb"), HelpText = "", Instruction = "Henger det gjenstander over kundens betjeningsområde?", Order = 6, RequirementItemId = new Guid("875e76b5-c926-43a0-8738-c4f41c7a0b8b"), StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2"), ToolsNeed = "Ingen", ViewIfParentFailed = false },
                        new { Id = new Guid("b504bde7-1394-4e5c-84d3-a3ac53fc7dd6"), ChapterItemId = new Guid("b80b9b15-8f0e-4702-b7d9-95cafa68f9fb"), HelpText = "", Instruction = "Hvor mange cm over gulvet henger den laveste gjenstanden i kundens betjeningsområde?", Order = 7, RequirementItemId = new Guid("875e76b5-c926-43a0-8738-c4f41c7a0b8b"), StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2"), ToolsNeed = "Ingen", ViewIfParentFailed = true },
                        new { Id = new Guid("0d6c763e-e0f6-4049-adeb-ae9429262b57"), ChapterItemId = new Guid("5f5abe28-1a74-4242-acc8-4b881ee4973a"), HelpText = "", Instruction = "Står betalingsterminalen ved siden av en annen betalingsterminal, på rett linje?", Order = 1, RequirementItemId = new Guid("c65786bb-1b93-4153-b88c-935cc2a7ab60"), StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2"), ToolsNeed = "Ingen", ViewIfParentFailed = false },
                        new { Id = new Guid("b9498453-f173-499a-b01d-91cb469cc5ec"), ChapterItemId = new Guid("5f5abe28-1a74-4242-acc8-4b881ee4973a"), HelpText = "", Instruction = "Hvor mange cm er det mellom betalingsterminalene?", Order = 2, RequirementItemId = new Guid("c65786bb-1b93-4153-b88c-935cc2a7ab60"), StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2"), ToolsNeed = "Ingen", ViewIfParentFailed = true },
                        new { Id = new Guid("832e0843-cab3-4dbc-9799-974e283fcc0b"), ChapterItemId = new Guid("75468cd0-478b-45e9-8a8e-51b0e574fb3b"), HelpText = "Krav: Skilt skal plasseres over betalingsterminalen.<br /><br />Det skal være et skilt som er synlig på avstand utenfor kundens betjeningsområde. Formålet er at brukeren kan finne fram til betalingsterminalen.<br /><br />Skiltet skal være plassert over området der kunden skal betale varene sine. Det kan for eksempel være over kassen eller disken der betalingsterminalen er plassert.<br /><br />Eksempler på tekst på skilt er<br />- Kasse<br />- Betal her<br />- Kort og kontant<br />- Nummer på kasse<br />", Instruction = "Finnes det et skilt som viser hvor kunden skal betale varene sine?", Order = 1, RequirementItemId = new Guid("aebd662d-9dd5-4a27-88d5-19d6c5e12e5a"), StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2"), ToolsNeed = "Ingen", ViewIfParentFailed = false },
                        new { Id = new Guid("4c4cd93b-ad4c-49b3-af05-f9e9fc7cb15a"), ChapterItemId = new Guid("75468cd0-478b-45e9-8a8e-51b0e574fb3b"), Instruction = "Er skiltet plassert over området der kunden skal betale varene sine?", Order = 2, RequirementItemId = new Guid("aebd662d-9dd5-4a27-88d5-19d6c5e12e5a"), StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2"), ToolsNeed = "Ingen", ViewIfParentFailed = false },
                        new { Id = new Guid("5cec30b8-2c28-4f7e-b9d7-6655a745c2ef"), ChapterItemId = new Guid("75468cd0-478b-45e9-8a8e-51b0e574fb3b"), Instruction = "Er skiltet synlig på avstand utenfor kundens betjeningsområde?", Order = 3, RequirementItemId = new Guid("aebd662d-9dd5-4a27-88d5-19d6c5e12e5a"), StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2"), ToolsNeed = "Ingen", ViewIfParentFailed = false },
                        new { Id = new Guid("5b3af04b-f6c6-4425-a22f-c2e7479839a5"), ChapterItemId = new Guid("6c0f12f8-0a91-4849-b18f-2af735017fcd"), Instruction = "Hvor mange cm er det fra gulvet og opp til betalingsterminalen?", Order = 1, RequirementItemId = new Guid("e503322b-ed77-4b69-adc4-eca19b6eb97d"), StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2"), ToolsNeed = "Ingen", ViewIfParentFailed = false }
                    );
                });
            ...
            modelBuilder.Entity("Difi.Sjalvdeklaration.Shared.Classes.Declaration.Rules.Standard.ChapterItem", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("731a0f5c-f586-471f-b32c-ceb8027f735a"), ChapterHeading = "User operating space", ChapterNumber = "15291:2006 D.6.2", RequirementsInSupervisor = "Krav 3.1 Betjeningsområdet foran betalingsterminalen skal være minst 150 x 150 centimeter. Betjeningsområdet skal være uten hindringer", StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2") },
                        new { Id = new Guid("b80b9b15-8f0e-4702-b7d9-95cafa68f9fb"), ChapterHeading = "Overhead obstructions", ChapterNumber = "15291:2006 D.5.5", RequirementsInSupervisor = "Krav 3.1 Betjeningsområdet foran betalingsterminalen skal være minst 150 x 150 centimeter. Betjeningsområdet skal være uten hindringer", StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2") },
                        new { Id = new Guid("5f5abe28-1a74-4242-acc8-4b881ee4973a"), ChapterHeading = "Access from user operating area", ChapterNumber = "15291:2006 D.6.6", RequirementsInSupervisor = "Krav 3.5 Dersom to eller flere automater står ved siden av hverandre, skal det være minst 150 centimeter fra midten av automaten til midten av neste automat.", StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2") },
                        ...
                        new { Id = new Guid("6c0f12f8-0a91-4849-b18f-2af735017fcd"), ChapterHeading = "Layout of operating features", ChapterNumber = "15291:2006 6.3.1", RequirementsInSupervisor = "Krav 4.2: Høyden på betjeningskomponenter som skjerm og tastatur skal være mellom 75 centimeter og 130 centimeter over gulvet. ", StandardItemId = new Guid("7851b33f-4cec-405c-8533-53cf7a6832e2") }
                    );
                });

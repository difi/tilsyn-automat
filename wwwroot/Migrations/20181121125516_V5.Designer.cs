            ...
            modelBuilder.Entity("Difi.Sjalvdeklaration.Shared.Classes.Declaration.Rules.AnswerItem", b =>
                {
                    ...
                    b.Property<bool>("ViewIfParentCorrect");
                    ...
                    b.HasData(
                        new { Id = new Guid("02d2db89-3717-48e1-883e-8e526bf6c727"), Bool = false, MaxInt = 0, MinInt = 0, Order = 1, Question = "Finnes det hindringer i kundens betjeningsområde?", RuleItemId = new Guid("eb160c6c-3a9e-4dff-93df-577d9eab4e09"), TypeOfAnswerId = 2, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = false, ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") },
                        new { Id = new Guid("6912d4a0-b73b-4ecc-9fa8-49e1fd356635"), Bool = false, MaxInt = 0, MinInt = 0, Order = 2, Question = "Ta bilde", RuleItemId = new Guid("eb160c6c-3a9e-4dff-93df-577d9eab4e09"), TypeOfAnswerId = 4, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = false, ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") },
                        new { Id = new Guid("d7b40e3c-e7fa-44e5-b44f-750759c971cc"), Bool = false, MaxInt = 0, MinInt = 0, Order = 3, Question = "Beskriv hindringene i kundens betjeningsområde.", RuleItemId = new Guid("eb160c6c-3a9e-4dff-93df-577d9eab4e09"), TypeOfAnswerId = 1, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = true, ViewIfParentFailedId = new Guid("02d2db89-3717-48e1-883e-8e526bf6c727") },
                        new { Id = new Guid("a1964762-5c8f-40bb-a22d-c907149079d4"), Bool = false, MaxInt = 0, MinInt = 0, Order = 1, Question = "Henger det gjenstander over kundens betjeningsområde?", RuleItemId = new Guid("b64cac7e-6525-49e8-9112-0238e1588ed8"), TypeOfAnswerId = 2, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = false, ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") },
                        new { Id = new Guid("8a12d92b-8a6a-44e7-9517-74331a4c2483"), Bool = false, MaxInt = 0, MinInt = 0, Order = 2, Question = "Ta bilde", RuleItemId = new Guid("b64cac7e-6525-49e8-9112-0238e1588ed8"), TypeOfAnswerId = 4, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = false, ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") },
                        new { Id = new Guid("bf459d05-702d-47d7-a5b7-19f8b3fb67c9"), Bool = false, MaxInt = -1, MinInt = 220, Order = 3, Question = "Hvor mange cm over gulvet henger den laveste gjenstanden i kundens betjeningsområde?", RuleItemId = new Guid("b64cac7e-6525-49e8-9112-0238e1588ed8"), TypeOfAnswerId = 3, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = true, ViewIfParentFailedId = new Guid("a1964762-5c8f-40bb-a22d-c907149079d4") },
                        new { Id = new Guid("202d20e0-61df-4a7c-8287-104e3b439f64"), Bool = false, MaxInt = 0, MinInt = 0, Order = 1, Question = "Står betalingsterminalen ved siden av en annen betalingsterminal, på rett linje?", RuleItemId = new Guid("0d6c763e-e0f6-4049-adeb-ae9429262b57"), TypeOfAnswerId = 2, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = false, ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") },
                        new { Id = new Guid("13d6d530-e533-4510-9a66-8b862899dbdf"), Bool = false, MaxInt = 0, MinInt = 0, Order = 2, Question = "Ta bilde", RuleItemId = new Guid("0d6c763e-e0f6-4049-adeb-ae9429262b57"), TypeOfAnswerId = 4, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = false, ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") },
                        new { Id = new Guid("89fd2205-1047-403d-a5bd-f70a1de2f247"), Bool = false, MaxInt = -1, MinInt = 150, Order = 3, Question = "Hvor mange cm er det mellom betalingsterminalene?", RuleItemId = new Guid("0d6c763e-e0f6-4049-adeb-ae9429262b57"), TypeOfAnswerId = 3, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = true, ViewIfParentFailedId = new Guid("202d20e0-61df-4a7c-8287-104e3b439f64") },
                        new { Id = new Guid("d8611e84-0f00-4d75-bcab-cbf127fb68b5"), Bool = true, MaxInt = 0, MinInt = 0, Order = 1, Question = "Finnes det et skilt som viser hvor kunden skal betale varene sine?", RuleItemId = new Guid("832e0843-cab3-4dbc-9799-974e283fcc0b"), TypeOfAnswerId = 2, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = false, ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") },
                        new { Id = new Guid("c4870935-ee11-4557-a9c3-aca678c17565"), Bool = false, MaxInt = 0, MinInt = 0, Order = 2, Question = "Ta bilde", RuleItemId = new Guid("832e0843-cab3-4dbc-9799-974e283fcc0b"), TypeOfAnswerId = 4, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = false, ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") },
                        new { Id = new Guid("9a51cc68-857e-4822-ac81-0ec3ebe7bf43"), Bool = true, MaxInt = 0, MinInt = 0, Order = 3, Question = "Er skiltet plassert over området der kunden skal betale varene sine?", RuleItemId = new Guid("832e0843-cab3-4dbc-9799-974e283fcc0b"), TypeOfAnswerId = 2, ViewIfParentCorrect = true, ViewIfParentCorrectId = new Guid("d8611e84-0f00-4d75-bcab-cbf127fb68b5"), ViewIfParentFailed = false, ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") },
                        ...
                        new { Id = new Guid("f98f67e5-cf6a-4afe-8998-3132640f9d70"), Bool = false, MaxInt = 130, MinInt = 75, Order = 1, Question = "Hvor mange cm er det fra gulvet og opp til betalingsterminalen?", RuleItemId = new Guid("5b3af04b-f6c6-4425-a22f-c2e7479839a5"), TypeOfAnswerId = 3, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = false, ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") },
                        new { Id = new Guid("438787f3-b33b-489c-b5a8-2f046a634dea"), Bool = false, MaxInt = 0, MinInt = 0, Order = 2, Question = "Ta bilde", RuleItemId = new Guid("5b3af04b-f6c6-4425-a22f-c2e7479839a5"), TypeOfAnswerId = 4, ViewIfParentCorrect = false, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailed = false, ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") }
                    );
                });

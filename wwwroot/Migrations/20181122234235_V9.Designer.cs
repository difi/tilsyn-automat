            ...
            modelBuilder.Entity("Difi.Sjalvdeklaration.Shared.Classes.Declaration.Rules.AnswerItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = new Guid("8a12d92b-8a6a-44e7-9517-74331a4c2483"), Bool = false, MaxInt = 0, MinInt = 0, Order = 2, Question = "Ta bilde", RuleItemId = new Guid("b64cac7e-6525-49e8-9112-0238e1588ed8"), TypeOfAnswerId = 4, ViewIfParentCorrectId = new Guid("00000000-0000-0000-0000-000000000000"), ViewIfParentFailedId = new Guid("00000000-0000-0000-0000-000000000000") },

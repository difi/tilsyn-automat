            ...
            modelBuilder.Entity("Difi.Sjalvdeklaration.Shared.Classes.Declaration.Rules.IndicatorItem", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("692627b2-53bc-43f2-900d-44a40a21e7e9"), LastChanged = new DateTime(2018, 11, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "1 Kundens betjeningsområde ", Order = 1 },
                        new { Id = new Guid("6b4bf385-9174-4634-bc9e-bfbdab98586e"), LastChanged = new DateTime(2018, 11, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "2 avstand mellom automater ", Order = 2 },
                        new { Id = new Guid("c52eb3bc-6464-4dc9-b9f3-eb975e2a012c"), LastChanged = new DateTime(2018, 11, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "3 Plassering av skilt", Order = 3 },
                        new { Id = new Guid("5b2a0a78-039f-4173-bf9e-1ca0060d1c53"), LastChanged = new DateTime(2018, 11, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Utfall 4 Høyde på betalingsterm", Order = 4 }
                    );
                });
            ...
            modelBuilder.Entity("Difi.Sjalvdeklaration.Shared.Classes.Declaration.Rules.IndicatorTestGroup", b =>
                {
                    ...
                    b.HasData(
                        new { TestGroupItemId = new Guid("aec1869a-30f8-403c-b909-df115173f009"), IndicatorItemId = new Guid("692627b2-53bc-43f2-900d-44a40a21e7e9") },
                        new { TestGroupItemId = new Guid("aec1869a-30f8-403c-b909-df115173f009"), IndicatorItemId = new Guid("6b4bf385-9174-4634-bc9e-bfbdab98586e") },
                        new { TestGroupItemId = new Guid("b6c22ac9-d775-4dfd-ac8e-b4ca565ea3fb"), IndicatorItemId = new Guid("c52eb3bc-6464-4dc9-b9f3-eb975e2a012c") },
                        new { TestGroupItemId = new Guid("9aae6bc9-4b60-405c-81a7-ec142d8c1ca6"), IndicatorItemId = new Guid("5b2a0a78-039f-4173-bf9e-1ca0060d1c53") }
                    );
                });

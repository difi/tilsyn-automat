...
namespace Difi.Sjalvdeklaration.Shared.Classes.Declaration
{
    ...
    public class DeclarationTestItem
    {
        ...
        [Display(Name = "DeclarationItem")]
        [Required(ErrorMessage = "DeclarationItem - required field")]
        public DeclarationItem DeclarationItem { get; set; }

        [Display(Name = "OutcomeDataList")]
        [Required(ErrorMessage = "OutcomeDataList - required field")]
